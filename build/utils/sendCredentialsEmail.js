...
exports.sendCredentialsEmail = void 0;
const emailTransporter_1 = require("./emailTransporter");
const sendCredentialsEmail = async ({ to, user_name, password, company_name, loginUrl = process.env.MYMANAG_CLIENT_URL || "https://mymanag.vercel.app", systemName = "Inventasys", }) => {
    try {
        const htmlContent = `
