...
exports.sendPaymentApproveEmail = void 0;
const date_fns_1 = require("date-fns");
const emailTransporter_1 = require("./emailTransporter");
const sendPaymentApproveEmail = async ({ to, user_name, payment, isFirstActivation = false, }) => {
    try {
...
exports.sendPaymentApproveEmail = sendPaymentApproveEmail;
