...
exports.toBaseCurrencyExpr = exports.toOrderCurrency = exports.toBaseCurrency = exports.round2 = void 0;
...
const toBaseCurrency = (amount, currency, exchangeRate) => {
    if (currency === "Bs" && exchangeRate)
        return amount / exchangeRate;
    return amount;
};
exports.toBaseCurrency = toBaseCurrency;
...
const toOrderCurrency = (amount, documentCurrency, documentExchangeRate, fallbackCurrency, targetCurrency) => {
    const effective = documentCurrency ?? fallbackCurrency;
    if (effective === targetCurrency)
        return amount;
    if (!documentExchangeRate)
        return amount;
    return effective === "Bs"
        ? amount / documentExchangeRate
        : amount * documentExchangeRate;
};
exports.toOrderCurrency = toOrderCurrency;
...
const toBaseCurrencyExpr = (amountField, currencyField, exchangeRateField) => ({
    $cond: [
...
exports.toBaseCurrencyExpr = toBaseCurrencyExpr;
