...
exports.sendAccountsReceivableReminderEmail = void 0;
const emailTransporter_1 = require("./emailTransporter");
const sendAccountsReceivableReminderEmail = async ({ to, clientName, companyName, orderCode, orderDate, total, currency, }) => {
...
exports.sendAccountsReceivableReminderEmail = sendAccountsReceivableReminderEmail;
