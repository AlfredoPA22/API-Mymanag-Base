...
exports.businessDayBounds = businessDayBounds;
...
function fromBoliviaClock(year, month, day, hour, minute = 0) {
...
function businessDayBounds(reference, rollback) {
