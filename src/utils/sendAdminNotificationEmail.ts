...
interface AutoActivatedNotificationParams {
  company_name: string;
  plan: string;
  system: string;
  amount: number;
...
interface DoublePaymentAlertParams {
  paymentId: string;
  transactionId: string;
  amount: number;
}
...
export const sendAdminAutoActivatedEmail = async (params: AutoActivatedNotificationParams) => {
...
export const sendAdminDoublePaymentAlertEmail = async (params: DoublePaymentAlertParams) => {
